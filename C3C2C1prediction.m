...
i=1;
disp(num2str(time_obs(i)));
temp_RUL = RUL(1:end,time_obs(i));
[temp_RUL,I] = sort(temp_RUL);
temp_RUL = temp_RUL + time_obs(i);
temp_w = sample_w(1:end,i);
temp_w = temp_w(I);%%
f_3=cumsum(temp_w);
f_1=0.025;
f_4=0.015;
...
temp_w = temp_w(I);
f_3=cumsum(temp_w);
%b=sort(10*rand(1,10000));
% p=exp(-b/5);% probability of high level b is the charge pump flow,5 is the discharging pump mean flow
%p=ones(size(f_2));
f_1=0.025;
f_4=0.015;
f_2=0.150;
